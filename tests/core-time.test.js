...
test('AI 总结交易阶段区分集合竞价、午休、盘前盘后并声明未覆盖节假日', () => {
  const cases = [
    ...
    ['us', '2026-07-13T07:59:00Z', 'closed', '已收盘', false],
    ['us', '2026-07-13T08:00:00Z', 'pre', '盘前', false],
    ['us', '2026-07-13T12:00:00Z', 'pre', '盘前', false],
    ['us', '2026-07-13T13:30:00Z', 'regular', '常规交易时段', true],
    ['us', '2026-07-13T14:00:00Z', 'regular', '常规交易时段', true],
    ['us', '2026-07-13T20:00:00Z', 'post', '盘后', false],
    ['us', '2026-07-13T20:30:00Z', 'post', '盘后', false],
    ['us', '2026-07-14T00:00:00Z', 'closed', '已收盘', false],
